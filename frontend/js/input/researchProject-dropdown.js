document.addEventListener("DOMContentLoaded", () => {
    ...
    const submit_update_button = document.getElementById("custom_rp_button");
    // ----------------------------------------------------------------------
    ...
    inputField.addEventListener("focus", () => {
        ...
        .then(data => {
          ...
          .catch(error => {
            console.error('Error during research project GET request::', error);
          });
    ...
    function selectItem(item) {
        ...
        funderNameInput.value          = item.funder;
